...
#define LCD_RS_LOW(LCD)						(MGPIO_voidClearPin(LCD->ControlPorts[0],LCD->ControlPins[0]))
#define LCD_RS_HIGH(LCD)					(MGPIO_voidSetPin(LCD->ControlPorts[0],LCD->ControlPins[0]))

#define LCD_RW_LOW(LCD)						(MGPIO_voidClearPin(LCD->ControlPorts[1],LCD->ControlPins[1]))
#define LCD_RW_HIGH(LCD)					(MGPIO_voidSetPin(LCD->ControlPorts[1],LCD->ControlPins[1]))
